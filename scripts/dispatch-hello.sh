...
# Dispatches a one-off workflow to Stormchaser via NATS

GREEN='\033[0;32m'
BLUE='\033[0;34m'
NC='\033[0m' # No Color

STORM_FILE="tests/hello-world.storm"
...
echo "  kubectl logs -l app.kubernetes.io/instance=stormchaser-runner"

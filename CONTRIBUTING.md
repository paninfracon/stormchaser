# Contributing to Paninfracon

First off, thank you for considering contributing to Paninfracon! It's people like you that make Paninfracon such a great tool.

Paninfracon is an open source project and we love to receive contributions from our community — you! There are many ways to contribute, from writing tutorials or blog posts, improving the documentation, submitting bug reports and feature requests or writing code which can be incorporated into Paninfracon itself.
...
Unsure where to begin contributing to Paninfracon? You can start by looking through these `good first issue` and `help wanted` issues:

* [Good first issues](https://github.com/cydergoth/paninfracon/labels/good%20first%20issue) - issues which should only require a few lines of code, and a test or two.
* [Help wanted issues](https://github.com/cydergoth/paninfracon/labels/help%20wanted) - issues which should be a bit more involved than `good first issue` issues.

### Getting the code

1. Fork the repository on GitHub.
2. Clone your fork locally: `git clone https://github.com/cydergoth/paninfracon.git`
...
2. Open a pull request on the Paninfracon repository.
